        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="sm:col-span-2 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Professional removals, delivery and waste removal across London.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/book/house-move" className="hover:text-purple-400 transition-colors">House Move</Link></li>
              <li><Link href="/book/waste-removal" className="hover:text-purple-400 transition-colors">Waste Removal</Link></li>
              <li><Link href="/book/commercial-move" className="hover:text-purple-400 transition-colors">Commercial Move</Link></li>
              <li><Link href="/book/single-item" className="hover:text-purple-400 transition-colors">Single Item Delivery</Link></li>
              <li><Link href="/book/small-move" className="hover:text-purple-400 transition-colors">Small Move</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href={`mailto:${CONTACT.email}`} className="hover:text-purple-400 transition-colors">{CONTACT.email}</a></li>
            </ul>
          </div>
