  ...
  return (
    ...
    >
      ...
      {/* Soft neutral readability gradient — only darkens the left edge
          ...
          stays clean, bright and natural across the rest of the frame.
          Opacity reduced ~45% from original to preserve photo warmth. */}
      <div
        className="hero-grad-desktop absolute inset-0 pointer-events-none hidden sm:block"
        style={{
          background:
            "linear-gradient(100deg, rgba(0,0,0,0.32) 0%, rgba(0,0,0,0.18) 28%, rgba(0,0,0,0.07) 52%, rgba(0,0,0,0.01) 78%, rgba(0,0,0,0) 100%)",
        }}
      />
      {/* Mobile readability scrim — lightened to keep photos natural */}
      <div
        className="absolute inset-0 pointer-events-none sm:hidden"
        style={{
          background:
            "linear-gradient(180deg, rgba(0,0,0,0.30) 0%, rgba(0,0,0,0.22) 38%, rgba(0,0,0,0.12) 70%, rgba(0,0,0,0.04) 100%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,0.16) 100%)",
        }}
      />
              ...
              {slide.buttons.map((btn, i) => {
                ...
                return (
                  <button
                    ...
                    className={
                      isPrimary
                        ? "btn-purple inline-flex items-center justify-center font-semibold px-6 sm:px-7 py-2.5 sm:py-3 rounded-full text-[13.5px] sm:text-base"
                        : "inline-flex items-center justify-center bg-white/75 backdrop-blur-sm text-purple-900 font-semibold px-6 sm:px-7 py-2.5 sm:py-3 rounded-full border border-white/50 hover:bg-white/90 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 text-[13.5px] sm:text-base shadow-[0_2px_8px_-2px_rgba(0,0,0,0.15)]"
                    }
